package com.andreabonatti92.workmanager
...
class PhotoCompressionWorker(
    ...
    override suspend fun doWork(): Result {
        return withContext(Dispatchers.IO) {
            ...
            val compressionThresholdInByte = params.inputData.getLong(
            ...
            } while (outputBytes.size > compressionThresholdInByte && quality > 5)

            // saving the file into the file system
